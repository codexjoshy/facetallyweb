const styles = {
  ...
  btnPrimary:
    'bg-primary mt-4 py-4 px-6 text-white text-lg minmd:text-2xl font-IBMPlex font-medium rounded-lg hover:bg-primaryLight',
  btnBlack:
    'bg-black flex items-center py-2 px-4 rounded-md mt-2 w-fit cursor-pointer  hover:bg-primaryLight',
  btnBlack2:
    'bg-black flex w-36  rounded-md mt-2 w-fit cursor-pointer  hover:bg-primaryLight',
  btnIcon2: 'w-5 h-5 minmd:w-10 minmd:h-10 ',
  section: 'flex justify-center items-center p-16 sm:p-8',
  nav: 'flex justify-center items-center p-6 sm:p-3',
